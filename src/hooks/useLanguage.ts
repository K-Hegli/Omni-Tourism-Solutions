...
const translations = {
  en: {
    ...
    // About You Page
    'aboutYou.hero.title': 'Business Assessment',
    'aboutYou.hero.subtitle': 'Complete your strategic analysis to unlock growth opportunities and operational excellence.',
    'aboutYou.executive.title': 'Executive Summary',
    'aboutYou.executive.subtitle': 'Key insights and strategic priorities',
    'aboutYou.executive.description': 'This comprehensive business assessment provides strategic insights into your organization\'s current position, capabilities, and growth opportunities. The analysis covers SWOT factors, operational capabilities, and actionable recommendations for sustainable growth.',
    'aboutYou.executive.priorityTitle': 'Priority Actions:',
    'aboutYou.executive.priority1': 'Address high-priority SWOT items identified in the analysis',
    'aboutYou.executive.priority2': 'Focus on capability gaps in critical operational areas',
    'aboutYou.executive.priority3': 'Develop implementation roadmap for recommended improvements',
    'aboutYou.swot.title': 'SWOT Analysis',
    'aboutYou.swot.subtitle': 'Strategic assessment of Strengths, Weaknesses, Opportunities, and Threats',
    'aboutYou.capabilities.title': 'Business Capabilities',
    'aboutYou.capabilities.subtitle': 'Operational assessment and capability evaluation',
    'aboutYou.recommendations.title': 'Strategic Recommendations',
    'aboutYou.recommendations.subtitle': 'Actionable insights for business growth',
    'aboutYou.recommendations.immediate.title': 'Immediate Actions (Next 30 Days)',
    'aboutYou.recommendations.immediate.item1': 'Review and prioritize high-impact SWOT items',
    'aboutYou.recommendations.immediate.item2': 'Conduct stakeholder interviews for deeper insights',
    'aboutYou.recommendations.immediate.item3': 'Begin capability gap analysis for critical functions',
    'aboutYou.recommendations.shortTerm.title': 'Short-term Goals (3-6 Months)',
    'aboutYou.recommendations.shortTerm.item1': 'Implement recommended operational improvements',
    'aboutYou.recommendations.shortTerm.item2': 'Develop training programs for capability enhancement',
    'aboutYou.recommendations.shortTerm.item3': 'Establish monitoring systems for key performance indicators',
    'aboutYou.recommendations.longTerm.title': 'Long-term Vision (6-12 Months)',
    'aboutYou.recommendations.longTerm.item1': 'Achieve operational excellence across all assessed areas',
    'aboutYou.recommendations.longTerm.item2': 'Establish competitive advantages in key market segments',
    'aboutYou.recommendations.longTerm.item3': 'Build scalable systems for sustained growth',
    'aboutYou.printButton': 'Print Business Report',
  ...
  it: {
    ...
    // About You Page
    'aboutYou.hero.title': 'Valutazione Aziendale',
    'aboutYou.hero.subtitle': 'Completa la tua analisi strategica per sbloccare opportunità di crescita ed eccellenza operativa.',
    'aboutYou.executive.title': 'Riassunto Esecutivo',
    'aboutYou.executive.subtitle': 'Insight chiave e priorità strategiche',
    'aboutYou.executive.description': 'Questa valutazione aziendale completa fornisce insight strategici sulla posizione attuale della tua organizzazione, capacità e opportunità di crescita. L\'analisi copre fattori SWOT, capacità operative e raccomandazioni attuabili per crescita sostenibile.',
    'aboutYou.executive.priorityTitle': 'Azioni Prioritarie:',
    'aboutYou.executive.priority1': 'Affrontare elementi SWOT ad alta priorità identificati nell\'analisi',
    'aboutYou.executive.priority2': 'Concentrarsi su lacune di capacità in aree operative critiche',
    'aboutYou.executive.priority3': 'Sviluppare roadmap implementazione per miglioramenti raccomandati',
    'aboutYou.swot.title': 'Analisi SWOT',
    'aboutYou.swot.subtitle': 'Valutazione strategica di Forze, Debolezze, Opportunità e Minacce',
    'aboutYou.capabilities.title': 'Capacità Aziendali',
    'aboutYou.capabilities.subtitle': 'Valutazione operativa e valutazione delle capacità',
    'aboutYou.recommendations.title': 'Raccomandazioni Strategiche',
    'aboutYou.recommendations.subtitle': 'Insight attuabili per crescita aziendale',
    'aboutYou.recommendations.immediate.title': 'Azioni Immediate (Prossimi 30 Giorni)',
    'aboutYou.recommendations.immediate.item1': 'Rivedere e prioritizzare elementi SWOT ad alto impatto',
    'aboutYou.recommendations.immediate.item2': 'Condurre interviste stakeholder per insight più profondi',
    'aboutYou.recommendations.immediate.item3': 'Iniziare analisi lacune capacità per funzioni critiche',
    'aboutYou.recommendations.shortTerm.title': 'Obiettivi a Breve Termine (3-6 Mesi)',
    'aboutYou.recommendations.shortTerm.item1': 'Implementare miglioramenti operativi raccomandati',
    'aboutYou.recommendations.shortTerm.item2': 'Sviluppare programmi formazione per miglioramento capacità',
    'aboutYou.recommendations.shortTerm.item3': 'Stabilire sistemi monitoraggio per indicatori prestazione chiave',
    'aboutYou.recommendations.longTerm.title': 'Visione a Lungo Termine (6-12 Mesi)',
    'aboutYou.recommendations.longTerm.item1': 'Raggiungere eccellenza operativa in tutte le aree valutate',
    'aboutYou.recommendations.longTerm.item2': 'Stabilire vantaggi competitivi in segmenti chiave del mercato',
    'aboutYou.recommendations.longTerm.item3': 'Costruire sistemi scalabili per crescita sostenuta',
    'aboutYou.printButton': 'Stampa Report Aziendale',
